...
function NoChatHistoryPlaceholder({ name }) {
  return (
    <div className='flex flex-col items-center justify-center h-full text-center p-6'>
        ...
        <h3 className='text-xl font-semibold text-slate-200 mb-2'>No messages yet</h3>
        <p className='text-slate-400 max-w-md'>Start a conversation with {name} by sending a message below.</p>
    </div>
  )
}
